...
public class decorationsAdapter extends BaseAdapter {
    Context context;
    ...
    public decorationsAdapter(Activity context, ArrayList<String> shopname, ArrayList<String> shopaddress, ArrayList<String> imageurl) {
