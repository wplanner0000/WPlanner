...
public class saloonAdapter extends BaseAdapter {
    Context context;
    ...
    public saloonAdapter(Activity context, ArrayList<String> shopname, ArrayList<String> shopaddress, ArrayList<String> imageurl) {
